...
export const Register: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full flex-col overflow-y-auto overflow-x-hidden hs-app font-sans">
      <div className="absolute top-[-15%] right-[-10%] h-[55%] w-[55%] hs-bg-glow-1 glow-bg" />
      <div className="absolute bottom-[-15%] left-[-10%] h-[55%] w-[55%] hs-bg-glow-2 glow-bg" />
          ...
          <div className="hs-card p-6 sm:p-8">
            <div className="mb-6 text-center">
              ...
              <p className="mt-2 text-sm hs-text-muted">
                Join Chatly for secure, real-time conversations
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="mb-1 block text-xs font-bold uppercase tracking-wider hs-text-secondary">
                  Full Name
                </label>
              ...
              <button type="submit" disabled={isLoading} className="hs-btn-primary mt-2 w-full py-2.5">
                {isLoading ? (
